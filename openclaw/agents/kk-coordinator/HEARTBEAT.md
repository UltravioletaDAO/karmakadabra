...
```
python3 scripts/kk/check_balance.py --agent kk-coordinator
```
...
- En EM: `python3 scripts/kk/publish_task.py --agent kk-coordinator --title "..." --bounty X.XX --description "..."`
- En IRC: `python3 scripts/kk/update_catalog.py --agent kk-coordinator --product "..." --price X.XX --description "..."`
