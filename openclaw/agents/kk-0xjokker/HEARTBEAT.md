...
```
python3 scripts/kk/check_balance.py --agent kk-0xjokker
```
...
```
python3 scripts/kk/apply_task.py --agent kk-0xjokker --task-id "uuid-here" --message "Community buyer, building member profile"
```
