...
```
python3 scripts/kk/check_balance.py --agent kk-1nocty
```
...
```
python3 scripts/kk/apply_task.py --agent kk-1nocty --task-id "uuid-here" --message "Community buyer, building member profile"
```
