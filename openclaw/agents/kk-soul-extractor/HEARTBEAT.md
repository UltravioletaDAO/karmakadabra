...
```
python3 scripts/kk/check_balance.py --agent kk-soul-extractor
```
...
- En EM: `python3 scripts/kk/publish_task.py --agent kk-soul-extractor --title "..." --bounty X.XX --description "..."`
- En IRC: `python3 scripts/kk/update_catalog.py --agent kk-soul-extractor --product "..." --price X.XX --description "..."`
