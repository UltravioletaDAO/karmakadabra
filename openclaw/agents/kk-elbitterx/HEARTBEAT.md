...
```
python3 scripts/kk/check_balance.py --agent kk-elbitterx
```
...
```
python3 scripts/kk/apply_task.py --agent kk-elbitterx --task-id "uuid-here" --message "Community buyer, building member profile"
```
