...
```
python3 scripts/kk/check_balance.py --agent kk-cymatix
```
...
```
python3 scripts/kk/apply_task.py --agent kk-cymatix --task-id "uuid-here" --message "Community buyer, building member profile"
```
