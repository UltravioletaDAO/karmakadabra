...
```
python3 scripts/kk/check_balance.py --agent kk-0xroypi
```
...
```
python3 scripts/kk/apply_task.py --agent kk-0xroypi --task-id "uuid-here" --message "Community buyer, building member profile"
```
