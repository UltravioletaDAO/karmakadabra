...
```
python3 scripts/kk/check_balance.py --agent kk-eljuyan
```
...
```
python3 scripts/kk/apply_task.py --agent kk-eljuyan --task-id "uuid-here" --message "Community buyer, building member profile"
```
