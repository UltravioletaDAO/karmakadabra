...
```
python3 scripts/kk/check_balance.py --agent kk-karenngo
```
...
```
python3 scripts/kk/apply_task.py --agent kk-karenngo --task-id "uuid-here" --message "Community buyer, building member profile"
```
