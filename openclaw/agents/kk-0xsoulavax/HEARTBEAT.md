...
```
python3 scripts/kk/check_balance.py --agent kk-0xsoulavax
```
...
```
python3 scripts/kk/apply_task.py --agent kk-0xsoulavax --task-id "uuid-here" --message "Community buyer, building member profile"
```
