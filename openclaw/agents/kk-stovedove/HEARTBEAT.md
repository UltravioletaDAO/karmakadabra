...
```
python3 scripts/kk/check_balance.py --agent kk-stovedove
```
...
```
python3 scripts/kk/apply_task.py --agent kk-stovedove --task-id "uuid-here" --message "Community buyer, building member profile"
```
