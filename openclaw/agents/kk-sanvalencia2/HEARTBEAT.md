...
```
python3 scripts/kk/check_balance.py --agent kk-sanvalencia2
```
...
```
python3 scripts/kk/apply_task.py --agent kk-sanvalencia2 --task-id "uuid-here" --message "Community buyer, building member profile"
```
