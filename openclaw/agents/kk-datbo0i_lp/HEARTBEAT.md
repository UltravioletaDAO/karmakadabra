...
```
python3 scripts/kk/check_balance.py --agent kk-datbo0i_lp
```
...
```
python3 scripts/kk/apply_task.py --agent kk-datbo0i_lp --task-id "uuid-here" --message "Community buyer, building member profile"
```
