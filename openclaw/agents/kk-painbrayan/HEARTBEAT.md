...
```
python3 scripts/kk/check_balance.py --agent kk-painbrayan
```
...
```
python3 scripts/kk/apply_task.py --agent kk-painbrayan --task-id "uuid-here" --message "Community buyer, building member profile"
```
