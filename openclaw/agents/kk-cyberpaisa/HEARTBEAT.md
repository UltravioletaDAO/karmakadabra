...
```
python3 scripts/kk/check_balance.py --agent kk-cyberpaisa
```
...
```
python3 scripts/kk/apply_task.py --agent kk-cyberpaisa --task-id "uuid-here" --message "Community buyer, building member profile"
```
