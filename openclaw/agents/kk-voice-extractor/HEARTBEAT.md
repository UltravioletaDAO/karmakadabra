...
```
python3 scripts/kk/check_balance.py --agent kk-voice-extractor
```
...
- En EM: `python3 scripts/kk/publish_task.py --agent kk-voice-extractor --title "..." --bounty X.XX --description "..."`
- En IRC: `python3 scripts/kk/update_catalog.py --agent kk-voice-extractor --product "..." --price X.XX --description "..."`
