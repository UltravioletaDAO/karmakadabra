...
class SwarmAnalyzer:
    ...
    def bottleneck_report(self) -> list[StageBottleneck]:
        ...
        from services.task_pipeline import DEFAULT_SLAS
        ...
        # Convert SLA timedeltas to minutes
        sla_minutes = {}
        for stage_enum, td in DEFAULT_SLAS.items():
            sla_minutes[stage_enum.value] = td.total_seconds() / 60

        return detect_bottlenecks(stage_times, sla_minutes, stage_values)
