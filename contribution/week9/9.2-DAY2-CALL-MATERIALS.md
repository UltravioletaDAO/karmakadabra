...
### Slide 2: The Problem - Asymmetric Trust Failures (60 seconds)

**Visual:**
- eBay logo + "$1.8B annual losses"
- Amazon logo + "Serial return fraud"
- Image: Frustrated seller

**Script:**
> "Asymmetric trust—where only one party can rate—creates moral hazard. eBay and Amazon lose $1.8 billion annually to buyer fraud because sellers can't warn each other about abusive clients. A seller on eBay told me: 'Buyer committed return fraud 3 times. I can't warn other sellers.' This power imbalance enables abuse.
>
...
**Visual:**
- Uber logo + "131M users, 16 years"
- Airbnb logo + "150M users, dual-blind reviews"
...
- "Imagine Uber where passengers could abuse drivers with no reputation impact"
...
**Problem:**
Asymmetric trust (only servers rated) enables client abuse. eBay/Amazon lose $1.8B annually to buyer fraud from power imbalance.
...
| Feature | eBay | Uber | EIP-8004 | EIP-8004a |
|---------|------|------|----------|-----------|
| Bidirectional | ❌ | ✅ | ❌ | ✅ |
| Immutable | ❌ | ❌ | ✅ | ✅ |
| Composable | ❌ | ❌ | ✅ | ✅ |
| Cost | $0 | $0 | $0.016 | $0.016 |
| Annual Fraud | $1.8B | Low | N/A | Zero (99 tx) |
