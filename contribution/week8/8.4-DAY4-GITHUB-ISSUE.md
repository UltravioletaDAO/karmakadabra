...
**Problem:** Asymmetric trust systems create moral hazard. Platforms like eBay and Amazon lose **$1.8B+ annually** to buyer fraud because sellers cannot warn each other about abusive clients. EIP-8004 currently implements server-only reputation, inheriting this asymmetry.
...
| Platform | Bidirectional? | Immutable? | Censorship-Resistant? | Composable? | Cost |
|----------|----------------|------------|----------------------|-------------|------|
| eBay/Amazon | ❌ No | ❌ No | ❌ No | ❌ No | $0 |
| Uber/Lyft | ✅ Yes | ❌ No | ❌ No | ❌ No | $0 |
| Airbnb | ✅ Yes (dual-blind) | ❌ No | ❌ No | ❌ No | $0 |
| EIP-8004 (base) | ❌ No | ✅ Yes | ✅ Yes | ✅ Yes | $0.016 |
| EIP-8004a (proposed) | ✅ Yes | ✅ Yes | ✅ Yes | ✅ Yes | $0.016 |

**Key insight:** Bidirectional trust works (Uber/Airbnb proof), blockchain adds immutability + composability.
